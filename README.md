...
- [doramirdor/NadirClaw](https://github.com/doramirdor/NadirClaw) - Open-source LLM router that saves you money. Routes simple prompts to cheap/local models, complex ones to premium — automatically. OpenAI-compatible proxy.
