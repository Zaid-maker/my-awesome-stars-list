...
- [Pipelex/cocode](https://github.com/Pipelex/cocode) - A command-line tool that turns code repositories into context and analyzes them with AI methods run by Pipelex.
