...
- [doramirdor/NadirClaw](https://github.com/doramirdor/NadirClaw) - Smart LLM router that cuts AI costs by 40-70%. Routes simple prompts to cheap/local models, complex ones to premium. Works with Claude Code, OpenClaw, Cursor. OpenAI-compatible proxy, runs locally.
