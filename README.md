...
- [JeanMeijer/analog](https://github.com/JeanMeijer/analog) - Meet the calendar that changes everything
...
- [vyancharuk/llm-powered-nodejs-api-boilerplate](https://github.com/vyancharuk/llm-powered-nodejs-api-boilerplate) - 🛠️ A production-ready LLM-Powered Node.js & TypeScript REST API template, with a focus on Clean Architecture
